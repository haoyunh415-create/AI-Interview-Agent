...
class TestFormatReport:
    def test_full_scores(self):
        report = Evaluator.format_report({
            "correctness": 8, "logic": 7, "depth": 6, "expression": 9,
            "summary": "Good answer", "improvement": "Go deeper",
    ...
    def test_report_with_followup(self):
        report = Evaluator.format_report({
            "correctness": 5, "logic": 5, "depth": 5, "expression": 5,
            "summary": "OK", "improvement": "Study more",
            "needs_followup": True, "followup_reason": "Too shallow",
        })
    ...
    def test_report_without_followup(self):
        report = Evaluator.format_report({
            "correctness": 8, "logic": 8, "depth": 8, "expression": 8,
            "summary": "Excellent", "improvement": "Keep going",
            "needs_followup": False,
        })
