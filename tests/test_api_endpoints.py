...
class TestAuth:
    ...
    def test_register_duplicate(self):
        client.post("/api/auth/register", json={
            "username": "dupuser", "password": "secret123",
        })
        resp = client.post("/api/auth/register", json={
            "username": "dupuser", "password": "secret456",
        })
        assert resp.status_code == 409

    def test_login_wrong_password(self):
        client.post("/api/auth/register", json={
            "username": "user1", "password": "correctpw",
        })
    ...
    def test_me_with_token(self):
        reg = client.post("/api/auth/register", json={
            "username": "meuser", "password": "secret123",
        })
...
class TestInterview:
    ...
    def test_answer_stream_sse_format(self, _init):
        ...
        resp = client.post("/api/interview/answer/stream", json={
            "session_id": sid,
    ...
    def test_hint_returns_text(self, _init):
        ...
        resp = client.post("/api/interview/hint", json={
            "session_id": sid,
        })
        assert resp.status_code == 200
    ...
    def test_report_requires_history(self, _init):
        ...
        resp = client.post("/api/interview/report", json={
            "session_id": sid,
        })
        assert resp.status_code == 400
...
class TestReport:
    ...
    def test_report_pdf_returns_file(self, _init):
        ...
        sid = start.json()["session_id"]
        client.post("/api/interview/answer", json={
            "session_id": sid, "answer": "Multi-head attention",
        })
...
class TestSessions:
    ...
    def test_search_interviews_returns_results(self, _init):
        ...
        sid = start.json()["session_id"]
        client.post("/api/interview/answer", json={
            "session_id": sid, "answer": "A detailed answer about transformers.",
        })
